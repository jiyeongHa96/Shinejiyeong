...
public class SalaryInputBean extends BaseBean{
	...
	/*
	 * private List<ExpensesDeductionBean> payDeductionList;
	 * 
	 * @Remove public List<ExpensesDeductionBean> getPayDeductionList() { return
	 * payDeductionList; }
	 * 
	 * @Remove public void setPayDeductionList(List<ExpensesDeductionBean>
	 * payDeductionList) { this.payDeductionList = payDeductionList; }
	 */
