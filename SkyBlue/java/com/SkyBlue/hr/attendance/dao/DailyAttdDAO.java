...
public interface DailyAttdDAO {
	//근태 목록 가져오기 
	public List<DailyAttdBean> selectDailyAttdList(Map<String,String> map);
	//근태 추가하기
	public void insertDailyAttd(DailyAttdBean dailyAttdBean);
	public void insertDailyAttdCheckOutByProcedure(Map<String,String> map);
	//미승인 일근태 내역 조회 
	public List<DailyAttdBean> selectDailyAttdListByCondition(ConditionBean conditionBean);

	public List<DailyAttdBean> selectDailyAttdListByInfo(ConditionBean conditionBean);
	...
	public void deleteDailyAttd(Map<String, String> map);
